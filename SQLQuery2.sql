...
-- if we want to query out day-wise covid cases we select date and then group them by date.
--Group By date
order by 1,2
...
--here we used cast to change the default datatype  to integer format.
